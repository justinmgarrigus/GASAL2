...
nvcc -dc ./obj/gasal_align.o -L${lib_path} -I${include_path} -DMAX_QUERY_LEN=160 -DN_CODE=0x4E -arch=sm_${sm_version} src/gasal_align.cu
nvcc -dlink -o ./obj/gasal_align_link.o -L${lib_path} -I${include_path} obj/gasal_align.o -DMAX_QUERY_LEN=160 -DN_CODE=0x4E -arch=sm_${sm_version}
